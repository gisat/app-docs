	...
	render() {
		...
		return (
			<Page title="Presentational map">
				<p>
					Presentational map components don't take care of data loading. They
					are not connected to the store and only display data.
				</p>
				<p>
					The API should be the same for all presentational map components in
					it's core, although some props may be specific for particular
					framework.
				</p>
				<p>
					Presentational map components could be used directly to display map
...
`}
				...
				Go to <Link to="./presentational/reactLeaflet">
					ReactLeafletMap
				</Link>{' '}
				section for details.
				<SyntaxHighlighter language="jsx">
