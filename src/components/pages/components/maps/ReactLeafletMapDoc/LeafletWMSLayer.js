	...
	render() {
		return (
			<Page title="Leaflet WMS layer">
				...
				<h2>Props</h2>
				<ComponentPropsTable>
					<Prop name="url" required type="string">Url of WMS service</Prop>
					...
					<Prop name="singleTile" defaultValue="false" type="bool">Request service in single image mode, dont use tile scheme. <Link to="#singleTileWMS">Example</Link></Prop>
					<Prop name="params" defaultValue="undefined" type="Object"><Link to="#params">WMS params</Link></Prop>
				</ComponentPropsTable>

				<h3 id="params">Params</h3>
				<p>WMS parameters are passed by <InlineCodeHighlighter>params</InlineCodeHighlighter> object. Each of key/value property is passed into WMS getMap request.</p>
				<p>Mandatory params depend on the end map service. Usually, <InlineCodeHighlighter>layers</InlineCodeHighlighter> property is mandatory.</p>
...
`}
                ...
                <p>In some cases is required to use single image WMS. It is possible by setting optional prop <InlineCodeHighlighter>singleTile</InlineCodeHighlighter> to <InlineCodeHighlighter>true</InlineCodeHighlighter>.</p>
				<div style={{height: 400, marginBottom: 10}}>
					<ReactLeafletMap
						mapKey='react-leaflet-map-2'
						view={view}
