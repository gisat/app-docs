...
import Page, {DocsToDo, InlineCodeHighlighter, SyntaxHighlighter} from "../../../../Page";
import {ReactLeafletMap, WorldWindMap, MapWrapper, PresentationMap, MapControls, MapSet} from "@gisatcz/ptr-maps";
    ...
    render() {
        return (
            <Page title="Map wrapper">
                <p>Map wrapper is used to add additional functionality to the map component (e.g. display name or enable removing the map from map set).</p>

                <h3>Props</h3>
                <ComponentPropsTable>
                    <Prop name="active" defaultValue="false" type="boolean">If true, a border is rendered around the map.</Prop>
                    <Prop name="onMapRemove" type="function">If defined, a button for map removal is rendered in the top left corner. The function is then called by clicking on the button.</Prop>
                    <Prop name="title" type="string | boolean">Title of the map displayed in the top left corner by default. If string, the value is used for title. If true, map <InlineCodeHighlighter>name</InlineCodeHighlighter> prop is used for title (if exists).</Prop>
                </ComponentPropsTable>
                ...
                <SyntaxHighlighter language="jsx">{`<MapWrapper 
...
`}
                ...
                <div style={{height: 400, width: 500}}>
                    <MapWrapper title="Title of the map" onMapRemove={()=>{window.alert("Remove")}}>
                        <ReactLeafletMap
                            mapKey="map1"
                            backgroundLayer={backgroundLayer}
                            view={view}
                ...
                <p>Use <InlineCodeHighlighter>wrapper</InlineCodeHighlighter> as prop of PresentationMap component to enable wrapper and <InlineCodeHighlighter>wrapperProps</InlineCodeHighlighter> to specify wrapper properties.</p>
...
`}
                ...
                <SyntaxHighlighter language="jsx">{`<ConnectedMapSet
...
`}
                ...
                <p>Use your own component as wrapper. All map props are passed to wrapper component.</p>

                <SyntaxHighlighter language="js">{`class MapCenterWrapper extends React.PureComponent {
    render() {
        const view = this.props.view;
