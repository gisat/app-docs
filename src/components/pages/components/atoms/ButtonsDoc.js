		...
		return (
			<Page title="Buttons">
				...
				<ComponentPropsTable
					content={[
						...
						},
						{
							...
							description: (
								<>
									Go to <Link to="#content">Content section</Link> to see how to
									handle with icons or visit{' '}
									<Link to="/components/atoms/icons">Icons</Link> documentation
									to choose the icon you need.
								</>
							),
						},
						{
						...
						},
						{
							...
							description: (
								<>
									See <Link to="#sizes">Sizes section</Link>
								</>
							),
						},
						{
						...
						},
						{
							...
							description: (
								<>
									See <Link to="#levels">Levels section</Link>
								</>
							),
						},
						{
				...
				<LightDarkBlock>
					<Buttons>
						<Button onClick={onClick}>
							Stay calm <br /> & enjoy Panther
						</Button>
						<Button onClick={onClick}>
							<>
								<b>Stay calm</b> and enjoy Panther
							</>
						</Button>
						<Button onClick={onClick}>
							<img src={pantherIcon} />
				...
				<LightDarkBlock>
					<Buttons>
						<Button onClick={onClick} invisible>
							Invisible
						</Button>
				...
				<LightDarkBlock>
					<Buttons>
						<Button onClick={onClick} ghost small>
							Search
						</Button>
						<Button onClick={onClick} ghost>
							Search
						</Button>
						<Button onClick={onClick} ghost large>
							Search
						</Button>
					</Buttons>
					<Buttons>
						<Button onClick={onClick} ghost small primary>
							Search
						</Button>
						<Button onClick={onClick} ghost primary>
							Search
						</Button>
						<Button onClick={onClick} ghost large primary>
							Search
						</Button>
					</Buttons>
				</LightDarkBlock>
				...
				<LightDarkBlock>
					...
					<div className="ptr-docs-panel-section">
						...
						<Button onClick={onClick} primary icon="delete">
							Primary
						</Button>
						<Button onClick={onClick} primary icon="download">
							Primary
						</Button>
						...
						<Button onClick={onClick} secondary icon="download">
							Secondary
						</Button>
						<Button onClick={onClick} secondary>
							Secondary
					...
					<div className="ptr-docs-panel-section">
						...
						<Button onClick={onClick} small primary>
							Primary
						</Button>
						<Button onClick={onClick} small secondary>
							Secondary
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section">
						...
						<Button onClick={onClick} large primary>
							Primary
						</Button>
						<Button onClick={onClick} large secondary>
							Secondary
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section">
						...
						<Button onClick={onClick} large primary icon="delete">
							Primary
						</Button>
						<Button onClick={onClick} large primary icon="download">
							Primary
						</Button>
						<Button onClick={onClick} large primary icon="plus">
							Primary
						</Button>
						<Button onClick={onClick} large secondary icon="delete">
							Secondary
						</Button>
						<Button onClick={onClick} large secondary icon="download">
							Secondary
						</Button>
						<Button onClick={onClick} large secondary>
							Secondary
					...
					<div className="ptr-docs-panel-section">
						...
						<Button onClick={onClick} disabled secondary>
							Secondary
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section">
						<Button onClick={onClick} disabled icon="delete">
							Basic
						</Button>
						<Button onClick={onClick} disabled primary icon="download">
							Basic
						</Button>
						<Button onClick={onClick} disabled secondary icon="plus">
							Basic
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section">
						<Button onClick={onClick} ghost icon="delete">
							Basic
						</Button>
						<Button onClick={onClick} ghost primary icon="download">
							Basic
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section">
						<Button onClick={onClick} ghost small icon="delete">
							Basic
						</Button>
						<Button onClick={onClick} ghost small primary icon="plus">
							Basic
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section">
						<Button onClick={onClick} ghost large icon="delete">
							Basic
						</Button>
						<Button onClick={onClick} ghost large primary icon="plus">
							Basic
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section">
						<Button onClick={onClick} ghost disabled>
							Basic
						</Button>
						<Button onClick={onClick} ghost disabled primary>
							Primary
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section inverted">
						...
						<Button onClick={onClick} inverted primary>
							Primary
						</Button>
						<Button onClick={onClick} inverted secondary>
							Primary
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section inverted">
						<Button onClick={onClick} inverted disabled>
							Basic
						</Button>
						<Button onClick={onClick} inverted disabled primary>
							Primary
						</Button>
						<Button onClick={onClick} inverted disabled secondary>
							Primary
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section inverted">
						<Button onClick={onClick} inverted invisible>
							Basic
						</Button>
					</div>
					...
					<div className="ptr-docs-panel-section inverted">
						<Button onClick={onClick} ghost inverted>
							Basic
						</Button>
						<Button onClick={onClick} ghost inverted primary>
							Primary
						</Button>
					</div>
