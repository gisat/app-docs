...
const AppStoryVerticalExample = () => {
	return (
		<div className='ptr-docs-story-verticalExample'>
			<AppStoryContent className={''} layout="vertical" theme="default">
...
AppStoryVerticalExample.propTypes = {};

export default AppStoryVerticalExample;
