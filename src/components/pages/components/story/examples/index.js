...
const StoryExamples = () => {
	return (
		<Page title="Examples">
			<h2>Horizontal layout & default theme & custom navigation & custom background & no footer</h2>
			<div className='ptr-docs-story-example'>
				<Story className={''} panelLayout={"horizontal"} theme={"default"}>
					<StorySidePanel className={''} navigationIcons={{home: "ri-city", case: "ri-square", footer: "ri-square"}}>
